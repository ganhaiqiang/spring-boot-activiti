...
public class ThreadPoolConfig {
	...
	/**
	 * 
	 * @description 线程池的初始化 采用spring线程池 二选一
	 ...
	 * 
	 * @description 特别说明
	 *              加上这个bean是因为集成activiti时，启用@EnableScheduling注解会报错，系统存在两个taskExecutor，所以特别指定这一个
	 * @return TaskExecutor
	 * @author 麻木神
